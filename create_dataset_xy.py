...
def bag_read(file_path):
    ...
    input1_array = np.array(error_adj_x)
    input2_array = np.array(error_adj_y)
    ...
    return input1_norm_array, input2_norm_array, output1_norm_array, output2_norm_array
...
pickle.dump(dataset, open('dataset100_xy_norm_-1_1_m0.pkl', 'wb'))