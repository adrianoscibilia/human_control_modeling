...
base_dir_from_linux = '/home/adriano/projects/bag/controller_adriano'
experiment_path = '/Claudia_Pagano/step/step_1.bag'
file_name = base_dir_from_linux + experiment_path

# def baganalyze(file_name):
...
# return len(error_adj_array), len(force_array)
...
# plt.figure(1)
# plt.plot(time_adj[:1000], ref_pos_plt[:1000])
# plt.plot(time_adj[:1000], act_pos_plt[:1000])
...
plt.figure(2)
plt.plot(time_adj, error_adj_array)
plt.xlabel("time")
plt.ylabel("position")
plt.grid()
...
# # create data folder
# bag_folder = '/home/adriano/projects/ros_ws/src/controller_adriano/bag/Marco_Faroni/step/'
# len_X = 0
# len_Y = 0
# for i in range(1, 11):
...
#
#     len_x, len_y = baganalyze(bag_input)
#     len_X = len_X + len_x
#     len_Y = len_Y + len_y
...
#     # writer.writerow(row)
#     # outfile.close()
# print("error shape: ", len_X)
# print("force shape: ", len_Y)
